...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ReferPageWidget.routeName,
          path: ReferPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ReferPage')
              : ReferPageWidget(),
        ),
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ContestPage')
              : ContestPageWidget(),
        ),
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'WithdrawPage')
              : WithdrawPageWidget(),
        )
